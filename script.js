...
function displayResults() {
    ...
    for (let i = 0; i < $resultsTab.length - 1; i++) {
        ...
        if (i == 13) newResSpan.innerHTML = `<img class="imgSVG3" src="bootstrap-icons-1.1.0/question-circle.svg" alt="">`;
        if (i == 14) newResSpan.innerHTML = `<img class="imgSVG3" src="bootstrap-icons-1.1.0/cup.svg" alt="">`;
...
function updateScores(userData) {
    ...
    if (userData[1] - 1 == 12) scoreView = `<img class="imgSVG3" src="bootstrap-icons-1.1.0/question-circle.svg" alt="">`;
    if (userData[1] - 1 == 13) scoreView = `<img class="imgSVG3" src="bootstrap-icons-1.1.0/cup.svg" alt="">`;
    if (userData[1] - 1 == 15) scoreView = '';
    if (userData[2] == 0) imgPerson = `<img class="imgSVGs" src="bootstrap-icons-1.1.0/person.svg" alt="admin">`;
